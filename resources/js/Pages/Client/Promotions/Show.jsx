...
export default function Show({ promotion }) {
    return (
        <ClientLayout>
            <Head>
                <title>{useTrans("Promotion")}</title>
                <meta
                    name="description"
                    content={useTrans(
                        "Profitez des promotions exclusives de l'hôtel Sidi El Noui et réservez votre séjour à prix réduit."
                    )}
                />
            </Head>
            ...
            <PageHeading title={"Promotion"} className="my-10 relative" />
